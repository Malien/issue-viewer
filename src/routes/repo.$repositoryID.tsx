...
function RepoSidebar({ queryRef }: { queryRef: PreloadedQuery<repoQuery> }) {
...
function RepoHeader(props: { repo: repoHeaderFragment$key }) {
  ...
  return (
    <>
      ...
      <RepoDescription repo={repo} className="col-span-2 text-stone-500 mt-2" />
    </>
  );
}
